<script lang="ts">
	...
	interface Props {
		...
		/** Called when favorite toggle is clicked */
		onToggleFavorite?: (project: ProjectConfig) => void;
		/** Custom class */
		class?: string;
	}
...
>
	...
	<div class="card-header">
		...
		<div class="card-actions" class:has-favorite={project.favorite}>
			<!-- Favorite toggle -->
			<button
				class="action-btn favorite"
				class:is-favorite={project.favorite}
...
<style>
	...
	/* When a project is favorited, the star stays visible even without hover */
	.card-actions.has-favorite .action-btn.favorite.is-favorite {
		opacity: 1;
	}

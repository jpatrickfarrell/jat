...
>
	...
	<div class="card-header">
		...
		<!-- Favorite toggle (separate from card-actions for independent visibility) -->
		<button
...
<style>
	...
	/* Favorite button — independent from card-actions opacity */
	.favorite-btn {
		display: flex;
		align-items: center;
		justify-content: center;
	...
	/* Show on card hover (unfavorited state) */

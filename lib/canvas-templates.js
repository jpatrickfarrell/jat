  ...
  },
  {
    ...
    blocks: () => [
      ...
      { type: 'divider', id: generateBlockId() },
      {
        type: 'formula',
        id: generateBlockId(),
        expression: '"Active Agents: " & CountIf(tasks, "status", "in_progress")',
        name: 'active_agents',
      },
      {
        type: 'table_view',
  ...
  },
  {
    ...
    blocks: () => [
      ...
      { type: 'divider', id: generateBlockId() },
      {
        type: 'formula',
        id: generateBlockId(),
        expression: '"Open Tasks: " + CountIf({status}, "open")',
        name: 'open_count',
      },
      {
        type: 'formula',
        id: generateBlockId(),
        expression: '"In Progress: " + CountIf({status}, "in_progress")',
        name: 'in_progress_count',
      },
      {
        type: 'formula',
        id: generateBlockId(),
        expression: '"Blocked: " + CountIf({status}, "blocked")',
        name: 'blocked_count',
      },
      { type: 'divider', id: generateBlockId() },
      {
        ...
        id: generateBlockId(),
        tableName: 'tasks',
        controlFilters: { status: 'status', assignee: 'assignee' },
        visibleColumns: [
          'id',
          'title',
          'status',

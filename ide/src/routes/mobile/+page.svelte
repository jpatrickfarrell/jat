...
<div class="min-h-screen bg-base-100 flex flex-col items-center justify-start px-4 py-8 max-w-lg mx-auto">
	...
	<div class="w-full mt-6 grid grid-cols-2 gap-3">
		<a href="/mobile/inbox" class="card bg-base-200 hover:bg-base-300 transition-colors shadow-sm cursor-pointer">
			<div class="card-body py-4 px-4 gap-1">
				<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-info" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">

...
import { createCanvasPage, listCanvasPages } from './bases.js';
...
const templates = [
  ...
  },
  {
    ...
    blocks: () => [
      ...
      },
      {
        ...
        name: 'status',
        controlType: 'select',
        config: { staticOptions: ['open', 'in_progress', 'waiting', 'blocked', 'submitted', 'accepted', 'deployed', 'closed', 'dev'], multiSelect: true},
  ...
  },
  {
    ...
    blocks: () => [
      ...
      },
      {
        ...
        controlType: 'select',
        config: {
          staticOptions: ['in_progress', 'open', 'waiting', 'blocked', 'submitted', 'accepted', 'deployed', 'closed'],
          multiSelect: false,
        },
        value: 'in_progress',
      },
  ...
  },
  {
    ...
    blocks: () => [
      ...
      },
      {
        ...
        controlType: 'select',
        config: {
          staticOptions: ['open', 'in_progress', 'waiting', 'blocked', 'submitted', 'accepted', 'deployed', 'closed', 'dev'],
          multiSelect: false,
        },
        value: null,
      },
  ...
  },
  {
    id: 'epic-manager',
    name: 'Epic Manager',
    description: 'Track epics with progress overview, child tasks, and launch controls',
    category: 'project',
    blocks: () => [
      {
        type: 'text',
        id: generateBlockId(),
        content:
          '# Epic Manager\n\nSelect an epic to view its children, track progress, and launch agents. Filter by status to focus on active or blocked work.',
      },
      {
        type: 'control',
        id: generateBlockId(),
        ...
        controlType: 'select',
        config: {
          staticOptions: ['', 'open', 'in_progress', 'closed'],
          multiSelect: false,
        },
        value: '',
      },
      { type: 'divider', id: generateBlockId() },
      {
        ...
        id: generateBlockId(),
        expression:
          '"Epics: " + If({epic_status}, "status=" + {epic_status}, "all statuses")',
        name: 'epic_filter_label',
      },
      {
        type: 'table_view',
        id: generateBlockId(),
        tableName: 'tasks',
        controlFilters: { status: 'epic_status', issue_type: 'epic_type_filter' },
        visibleColumns: ['id', 'title', 'status', 'priority', 'assignee', 'updated_at'],
        sort: { column: 'priority', direction: 'ASC' },
      },
      {
        type: 'control',
        id: generateBlockId(),
        name: 'epic_type_filter',
        controlType: 'select',
        config: { staticOptions: ['epic'], multiSelect: false },
        value: 'epic',
      },
      { type: 'divider', id: generateBlockId() },
      {
        ...
        id: generateBlockId(),
        content:
          '## Child Tasks\n\nAll non-epic tasks shown below. Use the status filter to focus on ready or blocked work.',
      },
      {
        type: 'control',
        id: generateBlockId(),
      ...
      },
      {
        ...
        id: generateBlockId(),
        tableName: 'tasks',
        controlFilters: { status: 'child_status', issue_type: 'child_type_filter' },
        visibleColumns: [
          'id',
          'title',
          'status',
      ...
      },
      {
        type: 'control',
        id: generateBlockId(),
        name: 'child_type_filter',
        controlType: 'select',
        config: { staticOptions: ['task', 'bug', 'feature'], multiSelect: false },
        value: 'task',
      },
      { type: 'divider', id: generateBlockId() },
      {

...
export const TASK_STATUS_VISUALS: Record<string, TaskStatusVisual> = {
	...
	// WAITING: Paused pending counterparty input — will resume
	waiting: {
		badge: 'badge-info badge-outline',
		text: 'text-info',
		icon: 'M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z',
		...
		animation: undefined,
		label: 'Waiting',
		description: 'Waiting for counterparty input'
	},

	// ACCEPTED: Stakeholder approved, ready to deploy
	accepted: {
...
export interface IssueTypeVisual {
	icon: string;
	label: string;
	/** Heroicons 24px outline SVG path for <path stroke-linecap="round" stroke-linejoin="round" d={...} /> */
	svgPath: string;
...
const ISSUE_TYPE_VISUALS: Record<string, IssueTypeVisual> = {
	...
	feature: {
		icon: '✨',
		label: 'FEATURE',
		svgPath: 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM16.894 20.567 16.5 21.75l-.394-1.183a2.25 2.25 0 0 0-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 0 0 1.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 0 0 1.423 1.423l1.183.394-1.183.394a2.25 2.25 0 0 0-1.423 1.423Z',
	...
	task: {
		icon: '📋',
		label: 'TASK',
		svgPath: 'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 0 2-2h2a2 2 0 0 0 2 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01',
...
export const SESSION_STATE_VISUALS: Record<string, SessionStateVisual> = {
	...
	waiting: {
		...
		shortLabel: '⏳ Waiting',
		iconType: 'question',
		description: 'Agent asked a question and paused — needs human answer to continue',
		// StatusActionBadge colors - amber/gold, muted (no active session)
		bgColor: 'oklch(0.55 0.12 75 / 0.25)',
		textColor: 'oklch(0.82 0.14 75)',
		borderColor: 'oklch(0.55 0.12 75 / 0.4)',
		// SessionCard accent colors
		accent: 'oklch(0.72 0.16 75)',
		bgTint: 'oklch(0.72 0.16 75 / 0.08)',
		glow: 'oklch(0.72 0.16 75 / 0.3)',
		// Clock icon
	...
	waiting: [
		{
			...
			icon: 'M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182M2.985 19.644l3.181-3.182',
			variant: 'success',
			description: 'Spawn a new agent to answer and continue this task'
		},
		{
			id: 'view-task',
			label: 'View Task',
		...
		},
		{
			...
			variant: 'default',
			description: 'Reset to open so any agent can pick it up'
		}
	],
	idle: [
		{

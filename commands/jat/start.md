...
> ⚡ **BEGIN WITH TOOL CALLS — NO TEXT PREAMBLE.** Do NOT write any explanatory text before your first tool call. Generating text before tools causes Claude Code to pause and wait for user input, breaking autonomous operation. Jump directly to ROUND 1 tool calls.
